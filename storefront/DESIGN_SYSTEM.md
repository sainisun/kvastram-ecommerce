...
Welcome to the **Kvastram Storefront Design System**. This living document serves as the single source of truth for all developers and designers working on the project.
...
- **`--ds-transition`**: `cubic-bezier(0.25, 0.46, 0.45, 0.94)` — The signature Kvastram UI motion curve.
