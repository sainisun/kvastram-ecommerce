    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' js.stripe.com; style-src 'self' 'unsafe-inline' fonts.googleapis.com; img-src 'self' res.cloudinary.com images.unsplash.com data: blob:; font-src 'self' fonts.gstatic.com; connect-src 'self' api.kvastram.com kvastram.com localhost:*; frame-src js.stripe.com hooks.stripe.com; media-src 'self'; object-src 'none'; base-uri 'self'; form-action 'self'; upgrade-insecure-requests;"
          },
          {
