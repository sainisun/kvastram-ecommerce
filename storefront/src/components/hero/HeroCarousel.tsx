...
const SLIDES = [
    {
        ...
        description: 'Discover handcrafted elegance from master artisans in India and Italy. Each piece tells a story of generations of expertise.',
    ...
    },
    {
        ...
        title: 'Timeless \nElegance',
        description: 'Exquisite silk sarees hand-woven in Varanasi. A tribute to the golden era of craftsmanship.',
    ...
    },
    {
        ...
        title: 'Your Moment \nIn History',
        description: 'Intricate embroidery and luxurious fabrics for the most important day of your life.',
            ...
            <div className="overflow-hidden" ref={emblaRef}>
                <div className="flex touch-pan-y">
                    {SLIDES.map((slide, index) => (
                        <div className="relative flex-[0_0_100%] min-w-0 h-[85vh] min-h-[600px]" key={slide.id}>
                            {/* Background Image */}
                            <Image
                                src={slide.image}
                            ...
                            <div className={`absolute inset-0 flex items-center ${
                                slide.position === 'left' ? 'justify-start md:pl-24' : 
                                slide.position === 'right' ? 'justify-end md:pr-24' : 
                                'justify-center'
                            }`}>
                                <div className={`max-w-7xl w-full px-6 md:px-12 ${
                                    slide.position === 'right' ? 'text-right items-end' : 
                                    slide.position === 'center' ? 'text-center items-center' : 
                                    'text-left items-start'
                                } flex flex-col`}>
                                    
                                    <div className="max-w-xl animate-fade-in-up">
                                        <span className={`text-white/90 text-xs md:text-sm font-bold tracking-[0.3em] uppercase mb-6 block ${
                                            slide.position === 'center' ? '' : 'border-l-2 border-white pl-4'
                                        }`}>
                                            {slide.subtitle}
                                        </span>
                                        ...
                                        <p className={`text-white/90 text-lg md:text-xl mb-10 font-light max-w-md leading-relaxed ${
