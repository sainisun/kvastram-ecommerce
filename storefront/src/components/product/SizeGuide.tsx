        ...
        return (
            <div>
                <h3 className="text-sm font-bold uppercase tracking-widest text-stone-900 mb-4">
                    {guide.type === 'clothing' ? 'Clothing' : guide.type === 'shoes' ? 'Shoes' : 'Accessories'} Size Chart
                </h3>
                <table className="w-full text-sm text-center">
                    <thead className="bg-stone-50 text-stone-900 border-b border-stone-100">
                        <tr>
                            <th className="py-3 font-medium">Size</th>
                            {guide.measurements[0]?.chest && <th className="py-3 font-medium">Chest</th>}
                            {guide.measurements[0]?.waist && <th className="py-3 font-medium">Waist</th>}
                            {guide.measurements[0]?.hips && <th className="py-3 font-medium">Hips</th>}
                            {guide.measurements[0]?.length && <th className="py-3 font-medium">Length</th>}
                        </tr>
                    </thead>
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <table className="w-full text-sm text-center">
                            ...
                            <tbody className="divide-y divide-stone-100 text-stone-600">
                                <tr><td className="py-3 font-medium">XS</td><td>0-2</td><td>4-6</td><td>36-38</td><td>32-33</td><td>24-25</td></tr>
                                <tr><td className="py-3 font-medium">S</td><td>4-6</td><td>8-10</td><td>40-42</td><td>34-35</td><td>26-27</td></tr>
                                <tr><td className="py-3 font-medium">M</td><td>8-10</td><td>12-14</td><td>44-46</td><td>36-37</td><td>28-29</td></tr>
                                <tr><td className="py-3 font-medium">L</td><td>12-14</td><td>16-18</td><td>48-50</td><td>38-40</td><td>30-32</td></tr>
                                <tr><td className="py-3 font-medium">XL</td><td>16-18</td><td>20-22</td><td>52-54</td><td>42-44</td><td>34-36</td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    {/* Menswear Size Chart */}
                    <div>
                        <h3 className="text-sm font-bold uppercase tracking-widest text-stone-900 mb-4">Menswear</h3>
                        <table className="w-full text-sm text-center">
                            <thead className="bg-stone-50 text-stone-900 border-b border-stone-100">
                                <tr>
                                    <th className="py-3 font-medium">Size</th>
                            ...
                            <tbody className="divide-y divide-stone-100 text-stone-600">
                                <tr><td className="py-3 font-medium">S</td><td>34-36</td><td>34-36</td><td>44-46</td><td>34-36</td><td>28-30</td></tr>
                                <tr><td className="py-3 font-medium">M</td><td>38-40</td><td>38-40</td><td>48-50</td><td>38-40</td><td>32-34</td></tr>
                                <tr><td className="py-3 font-medium">L</td><td>42-44</td><td>42-44</td><td>52-54</td><td>42-44</td><td>36-38</td></tr>
                                <tr><td className="py-3 font-medium">XL</td><td>46-48</td><td>46-48</td><td>56-58</td><td>46-48</td><td>40-42</td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="bg-stone-50 p-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-4 text-sm text-stone-600">
                            ...
                            <div>
                                ...
                                <p>Measure around the fullest part of your hips, about 8" below your waistline.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-stone-50 p-6">
                        ...
                        <p className="text-sm text-stone-600 leading-relaxed">
                            ...
                            For detailed measurements of a specific item, please contact our concierge at concierge@kvastram.com or use the chat widget.
                        </p>
                    </div>
                </div>
            </div>
