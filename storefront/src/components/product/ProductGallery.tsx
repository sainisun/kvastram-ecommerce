...
export default function ProductGallery({ images, title, videos = [] }: ProductGalleryProps) {
    ...
    const handleNext = useCallback((e?: React.MouseEvent) => {
        ...
        // Update media type based on index
        const nextIndex = selectedIndex === totalMedia - 1 ? 0 : selectedIndex + 1;
    ...
    const currentVideoIndex = isCurrentVideo ? selectedIndex - validImages.length : -1;
    const currentVideo = isCurrentVideo && hasVideos ? videos[currentVideoIndex] : null;
