...
export default function ShareButtons({ 
    ...
    const encodedDescription = encodeURIComponent(description || 'Check out this product from Kvastram');
        ...
        <div className={`relative ${className}`}>
            ...
            {showDropdown && (
                <>
                    ...
                    {/* Dropdown */}
                    <div className="absolute right-0 mt-2 w-48 bg-white border border-stone-200 shadow-lg rounded-lg z-50 overflow-hidden">
                        <div className="py-1">
                            <button
