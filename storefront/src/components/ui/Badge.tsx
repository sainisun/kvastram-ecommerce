...
const badgeVariants = cva(
  'inline-flex items-center gap-1 rounded-[var(--ds-radius-pill)] border px-2.5 py-1 font-label text-body-xs font-semibold tracking-token-wide leading-token-tight transition-colors duration-[var(--ds-transition-fast)]',
  {
    variants: {
      variant: {
