...
export default async function Home() {
  ...
  return (
    <div className="bg-surface-page text-primary" style={{ '--homepage-gutter': 'var(--ds-home-gutter-mobile)' } as React.CSSProperties} data-homepage-generated-at={homepage.generated_at || undefined}>
      <script
