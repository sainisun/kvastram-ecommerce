...
function SuccessContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 text-center bg-white">
      ...
      <p className="text-stone-500 mb-8 max-w-md font-light">
        Thank you for choosing Kvastram. Your order has been confirmed and
        payment received. We will begin preparing it for shipment.
      </p>
      <div className="flex gap-4">
        ...
        <Link
          href="/account"
          className="border border-stone-300 text-stone-900 px-8 py-3 rounded-none uppercase tracking-widest text-xs font-bold hover:bg-stone-50 transition-colors"
        >
          View Orders
        </Link>
      </div>
