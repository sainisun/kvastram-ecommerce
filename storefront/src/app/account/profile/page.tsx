...
export default function ProfilePage() {
    ...
    if (loading || !customer) return <div className="min-h-screen flex justify-center items-center"><Loader2 className="animate-spin" /></div>;
        ...
        <div className="min-h-screen bg-stone-50 pt-24 pb-24">
            <div className="max-w-2xl mx-auto px-6">
                ...
                <div className="bg-white p-8 border border-stone-200 shadow-sm">
                    <h1 className="text-2xl font-serif text-stone-900 mb-6">Edit Profile</h1>

                    {message && (
                        <div className={`p-4 mb-6 text-sm rounded-sm ${message.type === 'success' ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'}`}>
                            {message.text}
                        </div>
                    )}
