    ...
    return (
        <div className="min-h-screen bg-stone-50 pt-24 pb-24">
            <div className="max-w-4xl mx-auto px-6">
                <Link href="/account" className="inline-flex items-center gap-2 text-stone-500 hover:text-stone-900 mb-8 text-sm transition-colors">
                    <ArrowLeft size={16} /> Back to Account
                </Link>

                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-3xl font-serif text-stone-900 mb-2">Addresses</h1>
                ...
                {showForm && (
                    <div className="bg-white border border-stone-200 shadow-sm p-6 mb-8">
                        <h2 className="text-lg font-serif mb-6">{editingId ? 'Edit Address' : 'New Address'}</h2>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-widest text-stone-500 mb-2">Address</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-widest text-stone-500 mb-2">Apartment, suite, etc. (optional)</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-widest text-stone-500 mb-2">Phone (optional)</label>
                                <input
                                    type="tel"
                ...
                {addresses.length === 0 && !showForm ? (
                    <div className="bg-white border border-stone-200 shadow-sm p-12 text-center">
                        ...
                        <h3 className="font-serif text-lg text-stone-900 mb-2">No Addresses Yet</h3>
                        <p className="text-stone-500 mb-6">Add an address to speed up checkout</p>
                        <button
                    ...
                    <div className="grid gap-4">
                        {addresses.map((address) => (
                            <div key={address.id} className="bg-white border border-stone-200 shadow-sm p-6 flex justify-between items-start">
                                <div>
                                    ...
                                    {address.phone && (
                                        <p className="text-sm text-stone-500 mt-2">{address.phone}</p>
                                    )}
                                    {address.is_default && (
