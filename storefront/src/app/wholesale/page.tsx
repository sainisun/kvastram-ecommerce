...
import { Package, TrendingUp, DollarSign, Globe, CheckCircle, Mail, Phone, FileText, ArrowRight } from 'lucide-react';
        ...
        <>
            <div className="min-h-screen bg-white">
                ...
                <section className="relative bg-gradient-to-br from-stone-900 via-stone-800 to-amber-900 text-white py-24 pt-32">
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        <div className="max-w-3xl">
                            <span className="text-amber-400 text-xs font-bold uppercase tracking-[0.3em] block mb-4">B2B Partnership</span>
                            <h1 className="text-5xl md:text-6xl font-serif mb-6 leading-tight">
                                Wholesale & <br />Bulk Orders
                            </h1>
                            <p className="text-xl text-stone-300 font-light leading-relaxed mb-8">
                                Partner with Kvastram to bring authentic artisanal luxury to your customers.
                                Exclusive pricing, dedicated support, and global logistics for retailers and distributors worldwide.
                            </p>
                            <div className="flex flex-wrap gap-4">
                                <a href="#inquiry" className="bg-amber-500 text-stone-900 px-8 py-4 font-bold uppercase tracking-widest text-xs hover:bg-amber-400 transition-colors">
                                    Request Pricing
                                </a>
                                <a href="#benefits" className="border-2 border-white text-white px-8 py-4 font-bold uppercase tracking-widest text-xs hover:bg-white hover:text-stone-900 transition-colors">
                                    Learn More
                                </a>
                            </div>
                        </div>
                ...
                <section id="benefits" className="py-20 bg-stone-50">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl font-serif text-stone-900 mb-4">Why Partner With Kvastram?</h2>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <div className="bg-white p-8 text-center">
                                ...
                                <h3 className="text-lg font-bold text-stone-900 mb-3">Competitive Pricing</h3>
                            ...
                            <div className="bg-white p-8 text-center">
                                ...
                                <h3 className="text-lg font-bold text-stone-900 mb-3">Flexible MOQ</h3>
                                <p className="text-sm text-stone-600 font-light leading-relaxed">
                            ...
                            <div className="bg-white p-8 text-center">
                                ...
                                <h3 className="text-lg font-bold text-stone-900 mb-3">Global Shipping</h3>
                                <p className="text-sm text-stone-600 font-light leading-relaxed">
                            ...
                            <div className="bg-white p-8 text-center">
                                ...
                                <h3 className="text-lg font-bold text-stone-900 mb-3">Marketing Support</h3>
                                <p className="text-sm text-stone-600 font-light leading-relaxed">
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl font-serif text-stone-900 mb-4">Wholesale Pricing Tiers</h2>
                            <p className="text-stone-600 font-light">Volume-based discounts to maximize your margins</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="border border-stone-200 p-8">
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-stone-500 mb-4">Perfect for boutiques</p>
                            ...
                            <div className="border-2 border-amber-500 p-8 relative bg-amber-50">
                                ...
                                <div className="mb-6">
                                    <h3 className="text-xl font-bold text-stone-900 mb-2">Growth</h3>
                                    <p className="text-sm text-stone-500 mb-4">For established retailers</p>
                            ...
                            <div className="border border-stone-200 p-8">
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-stone-500 mb-4">For distributors & chains</p>
                ...
                <section className="py-20 bg-stone-50">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-stone-600 font-light">Simple 4-step process to start ordering</p>
                        </div>

                        <div className="grid md:grid-cols-4 gap-8">
                            {[
                                { step: '01', title: 'Submit Inquiry', desc: 'Fill out the form below with your business details' },
                                { step: '02', title: 'Review & Quote', desc: 'Our team reviews and sends custom pricing within 24hrs' },
                                { step: '03', title: 'Sample Order', desc: 'Place a sample order to evaluate quality and fit' },
                                { step: '04', title: 'Bulk Orders', desc: 'Start ordering with flexible payment and shipping terms' }
                            ].map((item, i) => (
                ...
                <section id="inquiry" className="py-20 bg-white">
                    <div className="max-w-4xl mx-auto px-6">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-serif text-stone-900 mb-4">Request Wholesale Pricing</h2>
                            <p className="text-stone-600 font-light">Fill out the form and our team will contact you within 24 hours</p>
                        </div>
                        ...
                        {submitted ? (
                            <div className="bg-green-50 border border-green-200 p-12 text-center">
                                ...
                                <p className="text-stone-600">We&apos;ve received your inquiry and will respond within 24 hours.</p>
                            </div>
                        ) : (
                            <>
                                {error && (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-xs font-bold uppercase text-stone-500 mb-2">Company Name *</label>
                                            <input
                                                type="text"
                                                required
                                        ...
                                        <div>
                                            <label className="block text-xs font-bold uppercase text-stone-500 mb-2">Contact Name *</label>
                                            <input
                                                type="text"
                                                required
                                                className="w-full border-b border-stone-200 py-3 focus:outline-none focus:border-stone-900 transition-colors"
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <label className="block text-xs font-bold uppercase text-stone-500 mb-2">Phone *</label>
                                            <input
                                                type="tel"
                                                required
                                                className="w-full border-b border-stone-200 py-3 focus:outline-none focus:border-stone-900 transition-colors"
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-xs font-bold uppercase text-stone-500 mb-2">Country *</label>
                                            <input
                                                type="text"
                                                required
                                                className="w-full border-b border-stone-200 py-3 focus:outline-none focus:border-stone-900 transition-colors"
                                        ...
                                        <div>
                                            <label className="block text-xs font-bold uppercase text-stone-500 mb-2">Business Type *</label>
                                            <select
                                                required
                                    ...
                                    <div>
                                        <label className="block text-xs font-bold uppercase text-stone-500 mb-2">Estimated Monthly Order Volume</label>
                                        <select
                                            className="w-full border-b border-stone-200 py-3 focus:outline-none focus:border-stone-900 transition-colors bg-transparent"
                                            value={formData.estimated_order_volume}
                                            onChange={(e) => setFormData({ ...formData, estimated_order_volume: e.target.value })}
                                        >
                                            <option value="">Select...</option>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid md:grid-cols-3 gap-8 text-center">
                            <div>
                                ...
                                <a href="mailto:wholesale@kvastram.com" className="text-stone-400 hover:text-white text-sm">
                            ...
                            <div>
                                ...
                                <a href="tel:+1234567890" className="text-stone-400 hover:text-white text-sm">
                                    +1 (234) 567-890
                                </a>
                            </div>
                            <div>
