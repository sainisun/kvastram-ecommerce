      ...
      <div className="max-w-4xl mx-auto px-6 space-y-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-lg text-stone-600 font-light leading-relaxed">
            <p>
              Kvastram began with a simple question: Why must luxury define
              itself by exclusion? We believe true luxury lies in the hands that
              create it—the master weaver in Varanasi, the leather artisan in
              Florence, the silver smith in Jaipur.
            </p>
            <p>
              Our journey is one of connection. We travel to the source, meeting
              makers in their homes and workshops, building relationships that
              go beyond commerce.
            </p>
          </div>
        ...
        <div className="bg-stone-50 p-12 text-center space-y-6">
          ...
          <p className="max-w-2xl mx-auto text-stone-600 leading-relaxed">
            In a world of fast fashion, we choose the path of patience. Each
            Kvastram piece takes weeks, sometimes months, to create. We produce
            in small batches to ensure quality and minimize waste.
          </p>
        </div>
      </div>
    </div>
