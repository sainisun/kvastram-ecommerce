  ...
  return (
    <>
      <PageHero
        eyebrow="Craft Story"
        title="Our Craft"
        intro="Kvastram pieces are shaped by handmade textile traditions: block printing, quilting, embroidery, careful finishing, and small-batch production."
        breadcrumbs={[
          { label: 'Home', href: '/' },
      ...
      >
        <ImageTextSplit
          ...
          imageAlt="Hand embroidered Kvastram jacket showing textile detail"
          imageLabel="Hands arranging cotton, carved blocks, and quilt layers"
          body={
            <>
              <p>
                Every Kvastram piece begins with material choice: the feel of
        ...
        <CraftStorySection eyebrow="Process" title="A rhythm of many hands">
          ...
          <p>
            This is why Kvastram avoids the look of factory-perfect sameness.
