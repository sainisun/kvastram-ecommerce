  ...
  return (
    <>
      <PageHero
        ...
        intro="Block printing uses carved wooden blocks, repeat placement, and layered color to create the textile patterns seen across many Kvastram pieces."
        breadcrumbs={[
          { label: 'Home', href: '/' },
      ...
      >
        <ImageTextSplit
          ...
          imageAlt="Kvastram textile jacket with repeated surface motif"
          ...
          body={
            <>
              ...
              <p>
                Kvastram uses this language for pieces that feel warm, tactile,
