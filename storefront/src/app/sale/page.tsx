...
export default function SalePage() {
    ...
    useEffect(() => {
        api.getProducts({ limit: 50, sort: 'price' })
            .then(data => {
        ...
        <div className="min-h-screen bg-white">
            <div className="bg-amber-50 py-16 px-4 sm:px-6 lg:px-8 border-b border-amber-100">
                <div className="max-w-7xl mx-auto text-center space-y-4">
                    <span className="text-xs font-bold tracking-[0.2em] text-amber-600 uppercase">Limited Time</span>
                    <h1 className="text-4xl md:text-5xl font-serif text-stone-900">Sale</h1>
