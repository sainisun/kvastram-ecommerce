...
export const metadata: Metadata = buildBasicPageMetadata({
  title: 'Privacy Policy | Kvastram - How We Use Your Data',
  description:
    "Kvastram's Privacy Policy explains what data we collect, how we use it, who we share it with, and your rights.",
  path: '/pages/privacy-policy',
  keywords: ['Kvastram privacy policy', 'Kvastram data policy', 'Kvastram privacy'],
});
...
Kvastram operates from Jaipur, Rajasthan, India.  
...
When you browse or buy from kvastram.com, we may collect:
...
To exercise any of these rights, email support@kvastram.com with **Privacy Request** in the subject line.
...
export default function PrivacyPolicyPage() {
  return (
    <StaticPolicyPage
      ...
      path="/pages/privacy-policy"
      description="Read how Kvastram collects, uses, shares, and protects customer data."
      content={content}
    />
  );
}
