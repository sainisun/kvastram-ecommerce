...
export const metadata: Metadata = buildBasicPageMetadata({
  title: 'Shipping & Returns Policy | Kvastram - Handmade India',
  description:
    'Kvastram ships across India and internationally. Read our shipping timelines, return eligibility, refund process, and exchange rules before you buy.',
  path: '/pages/shipping-returns',
  keywords: ['Kvastram shipping policy', 'Kvastram returns', 'Kvastram refund policy'],
});
...
Once your order is dispatched, you will receive a shipping confirmation email with a tracking link. You can also track your order at kvastram.com/track using your order number and email address.

---

### Customs, Duties, and Import Taxes

International buyers are responsible for any customs duties, import taxes, or brokerage fees charged by their country's customs authority. These charges are not collected by Kvastram and are not included in your order total or shipping fee.
...
1. Email support@kvastram.com within 15 days of delivery.
...
If you would like a different size, colour, or product, email support@kvastram.com. We will confirm availability before you return your item. Exchanges are processed once the original item is received and inspected.
...
export default function ShippingReturnsPage() {
  return (
    <StaticPolicyPage
      ...
      path="/pages/shipping-returns"
      description="Read Kvastram shipping timelines, return eligibility, refund handling, and exchange rules."
      content={content}
    />
  );
}
