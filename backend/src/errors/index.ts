...
export class ValidationError extends AppError {
    ...
    constructor(message: string = 'Validation failed', fieldErrors?: Record<string, string[]>, details?: unknown) {
...
export class InsufficientStockError extends BusinessLogicError {
    constructor(items: { title: string; requested: number; available: number }[]) {
 ...
 */
export function throwValidationError(message: string, fieldErrors?: Record<string, string[]>): never {
 ...
 */
export function throwAuthenticationError(message: string = 'Authentication failed'): never {
