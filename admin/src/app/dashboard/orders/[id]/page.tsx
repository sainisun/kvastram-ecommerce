...
import { ArrowLeft, MapPin, User, Package, CreditCard, ChevronDown, Printer } from 'lucide-react';
        ...
        <div>
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800">Order #{order.display_id}</h1>
                                ...
                                <div key={item.id} className="p-6 flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-sm text-gray-500">
                                            {item.quantity} x {formatCurrency(item.unit_price, order.currency_code)}
                                        </p>
                                    </div>
                                </div>
                            ))}
                ...
                <div className="space-y-6">
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                        ...
                        <div className="border-t border-gray-100 pt-4">
                            <h3 className="text-xs font-semibold text-gray-500 uppercase mb-2">Contact Info</h3>
                            <p className="text-sm text-gray-600">{order.customer?.phone || 'No phone provided'}</p>
                        </div>
                    </div>
