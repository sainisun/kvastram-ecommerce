    ...
    return (
        <div className="p-8">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-600">Manage your customers and view their purchase history</p>
            </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{stats.customers_with_accounts}</p>
                            </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{stats.guest_customers}</p>
                            </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{stats.customers_with_orders}</p>
                            </div>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg font-medium transition-colors ${filter === 'guest'
                                ? 'bg-blue-500 text-white'
                                : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                }`}
                        >
                            ...
                            {loading ? (
                                ...
                                customers.map((customer) => (
                                    <tr key={customer.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span
                                                className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${customer.has_account
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 w-full max-w-md">
                        ...
                        <p className="text-gray-700 mb-6">
                            ...
                            {deletingCustomer?.order_count && deletingCustomer.order_count > 0 ? (
                                <span className="text-red-600 block mt-2">
                                    Warning: This customer has {deletingCustomer.order_count} order(s).
                                </span>
                            ) : null}
                        </p>
